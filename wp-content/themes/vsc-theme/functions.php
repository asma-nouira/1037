...
wp_enqueue_style( 'vsc-theme-icons', get_template_directory_uri() . '/css/fonts/tabler-icons.min.css', array(), null );
wp_enqueue_style( 'vsc-theme-ison-style', get_template_directory_uri() . '/css/fonts/tabler-icons.scss', array(), null );
...
require get_template_directory() . '/inc/shortcode-histoire.php';
require get_template_directory() . '/inc/shortcode-recettes-archive.php';
